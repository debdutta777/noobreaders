...
const NovelCard = ({ novel }: NovelCardProps) => {
  ...
  return (
    <div className="novel-card-container relative">
      {/* Glow effect behind the card */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-500 rounded-lg opacity-0 group-hover:opacity-70 blur-xl transition-opacity duration-300 -z-10"></div>
